...
std::vector<byte> AssembleFluganWithOptionalSignatureParsing(std::vector<char> *assembly, bool assemble_signatures, std::vector<byte> *orig_bytecode, std::vector<AssemblerParseError> *parse_errors = nullptr);
